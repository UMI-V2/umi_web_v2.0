...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {{-- <form action="{{ route('users.edit', $user->id) }}" method="GET" enctype="multipart/form-data"> --}}

            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label>Nama Lengkap</label>
                        <input type="input" name="name" value="{{$user->name}}" class="form-control" placeholder="Nama Pengguna">
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Email</label>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="input" name="username" value="{{$user->username}}" class="form-control" placeholder="Username Account">
                    </div>
                    {{-- <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="input" name="no_hp" value="{{$user->no_hp}}" class="form-control" placeholder="Nomor HP">
                    </div>
