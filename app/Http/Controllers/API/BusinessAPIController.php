...
class BusinessAPIController extends Controller
{
    ...
    public function all(Request $request)
    {
        try {
            ...
            return ResponseFormatter::success($business->with(['users', 'business_file', 'open_hours', 'category.master_business_categories', 'address.sub_district'])->paginate($limit), 'Data Usaha berhasil diambil');
